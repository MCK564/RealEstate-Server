...
public class MessageKeys {
    ...
    public static final String PAYMENT_UNSUCCESSFULLY = "payment unsuccessfully";
    public static final String MAIL_SENT_SUCCESSFULLY = "sent_mail_successfully";
    public static final String PAYMENT_SUCCESS = "PAYMENT SUCCESS WITH ORDER #";
    public static final String UPLOAD_UNSUCCESSFULLY = "images upload unsuccessfully because of unsuitable content";
    public static final String OUT_OF_POSTS = "You have used up all your posting attempt";
}
